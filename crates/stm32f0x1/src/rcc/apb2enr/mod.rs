...
impl W {
    ...
    #[doc = "Bit 7 - USART8 clock enable"]
    #[inline]
    pub fn usart8en(&mut self) -> _USART8ENW {
        _USART8ENW { w: self }
    }
    #[doc = "Bit 6 - USART7 clock enable"]
    #[inline]
    pub fn usart7en(&mut self) -> _USART7ENW {
        _USART7ENW { w: self }
    }
    #[doc = "Bit 5 - USART6 clock enable"]
    #[inline]
