...
#[doc = r" Value of the field"]
pub struct TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTEDR {
    bits: bool,
}
impl TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTEDR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Proxy"]
pub struct _TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTEDW<'a> {
    w: &'a mut W,
}
impl<'a> _TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTEDW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    pub fn tim3_counter_stopped_when_core_is_halted(
        &self,
    ) -> TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTEDR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTEDR { bits }
    }
...
impl W {
    ...
    pub fn tim3_counter_stopped_when_core_is_halted(
        &mut self,
    ) -> _TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTEDW {
        _TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTEDW { w: self }
    }
    #[doc = "Bit 5 - TIM7 counter stopped when core is halted"]
    #[inline]
